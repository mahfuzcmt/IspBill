									...
									<div class="md-whiteframe-z1 mb20 text-center" style="padding: 15px">
										...
										<div class="col-md-4">
											<a href="{$_url}customers/add" class="btn btn-primary btn-block waves-effect"><i class="ion ion-android-add"> </i> {$_L['Add_Contact']}</a>
												...
												<a href="http://103.187.22.131:8090/" target="_blank" rel="noopener" class="btn btn-default btn-block" style="margin-top:6px"><i class="fa fa-external-link"></i> Open Router Web UI</a>
